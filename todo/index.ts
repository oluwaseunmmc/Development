...
let todos: { id: number, name: string, completed: boolean }[] = [];
...
function addToUl(todoList: { id: number, name: string, completed: boolean }[]): void {
...
function renderTodos(todos: { id: number, name: string, completed: boolean }[] ) {
